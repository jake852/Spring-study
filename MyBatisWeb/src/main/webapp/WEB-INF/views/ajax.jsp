...
<body>
	...
	<script type="text/javascript"> //jquery 필수문 
		$(document).ready(function() {		//function = 이벤트처리
			let person = {name: "ezen", age : 10}
			let person2 = {} //비어있는 객체
			$("#sendBtn").click(function() { 			//id검색 이니까 # 
				$.ajax({
					type : 'post', 		//요청 메서드 
					url : '/heart/send',	//요청 URI
					headers : { "content-type" : "application/json"},	//요청 헤더 
					dataType : 'text', 		// 전송받을 데이터의 타입 
					data : JSON.stringify(person),		// 서버로 전송할 데이터. stringify()로 직렬화
